...
git_brewery는 전 세계 양조장 데이터를 탐색하고 활용할 수 있는 간단한 파이썬 프로젝트입니다.
이 프로젝트는 양조장 정보를 가져오고 보기 좋은 테이블 형식으로 출력하는 도구를 제공하며,
개발자와 맥주 애호가 모두에게 유용합니다.
목차
[기능](#기능)
[프로젝트 구조](#프로젝트-구조)
[설치 방법](#설치-방법)
...
├── print_message.py    # 개발용 테스트 스크립트 (dev 브랜치)
